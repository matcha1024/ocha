...
# ==============================================================================
# python label_image.py --graph=retrained_graph.pb --labels=retrained_labels.txt --input_layer=Placeholder --output_layer=final_result --image=
...
def read_tensor_from_image_file(file_name,
                                ...
                                input_mean=0,
                                input_std=255):
  print("対応ファイルはpng, gif, bmp, jpgです。")
...
if __name__ == "__main__":
  ...
  for i in top_k:
    if(results[i] > highest_res):
      highest = labels[i]
      highest_res = results[i]
  ...
  if(highest == "ayataka"):
    erabareta="綾鷹"
      ...
      erabareta="伊右衛門"
  elif(highest == "namacha"):
      erabareta="生茶"
  print("選ばれたのは", erabareta, "でした。")
  print("====================================================================")
